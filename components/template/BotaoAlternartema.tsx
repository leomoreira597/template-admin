...
export default function BotaoAlternarTema(props: BotaoAlternarTemaProps) {
    return props.tema === 'dark' ? (
        <div onClick={props.alternarTema} className={`
         hidden sm:flex bg-gradient-to-r from-yellow-300 to-yellow-600 w-14 lg:w-24 h-8  items-center
        ...
        <div onClick={props.alternarTema} className={`
        hidden sm:flex justify-end bg-gradient-to-r from-gray-500 to-gray-900 w-14 lg:w-24 h-8  items-center
        cursor-pointer p-1 rounded-full
       `}>
